...
5. **Bước 5: Thực thi Kiểm thử trên Staging & Nghiệm thu (Sign-off) Hoàn tất Ticket Jira (`Pass Test` ✅):**
   ...
   - **Nghiệm thu (Sign-off) & Hoàn tất Ticket Jira:** Khi toàn bộ test case đạt **100% Passed**:
     - Chuyển trạng thái ticket Jira sang **`Pass Test`** ✅ để hoàn tất nghiệm thu ticket.
     - Tag các reviewer phụ trách (**Mohit**, **Dastan**, **Sandeep**).

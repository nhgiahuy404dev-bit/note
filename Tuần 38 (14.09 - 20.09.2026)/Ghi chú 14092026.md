...
flowchart TD
    ...
    %% Subgraph 2: Chuẩn hóa Jira & Tạo Test Artifact
...
5. **Gửi Dev Review Test Section trên Slack:**
   - Sau khi đã tạo ticket Jira và Test Artifact Confluence, gửi tin nhắn trao đổi trên Slack cho Dev phụ trách tính năng để chốt phạm vi kiểm thử:
...
6. **Bật Testing & Thực thi khi Dev deploy Staging:**
   ...
   - Nghiệm thu hoàn tất ➔ Chuyển Jira sang **`Pass Test`** ✅.
